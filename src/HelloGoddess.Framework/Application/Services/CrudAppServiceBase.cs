...
using HelloGoddess.Infrastructure.Linq.Extensions;
using HelloGoddess.Infrastructure.ObjectMapping;
...
namespace HelloGoddess.Infrastructure.Application.Services
{
        ...
        where TUpdateInput : IEntityDto<TPrimaryKey>
    {
        ...
        protected virtual IQueryable<TEntity> ApplySorting(IQueryable<TEntity> query, TGetAllInput input)
        {
            ...
            if (sortInput != null)
            {
                if (!sortInput.Sorting.IsNullOrWhiteSpace())
                {
                    ...
                    return (IQueryable<TEntity>)query.OrderBy(entity => entity.Id);
                }
            }
            ...
            {
                return (IQueryable<TEntity>)query.OrderByDescending(e => e.Id);
            }
        ...
        protected virtual IQueryable<TEntity> ApplyPaging(IQueryable<TEntity> query, TGetAllInput input)
        {
            ...
            {
                return (IQueryable<TEntity>)query.Take(limitedInput.MaxResultCount);
            }
