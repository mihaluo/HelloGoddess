...
namespace HelloGoddess.Infrastructure.Linq.Extensions
{
    /// <summary>
    ...
    public static class QueryableExtensions
    {
        ...
        public static IQueryable<T> PageBy<T>(this IQueryable<T> query, int skipCount, int maxResultCount)
        {
            ...
            return (IQueryable<T>)query.Skip(skipCount).Take(maxResultCount);
        }
        ...
        {
            var whereIf = (IQueryable<T>)query.Where(predicate.Compile());
            return condition
                ? whereIf
                : query;
        }
