namespace HelloGoddess.Infrastructure.Notifications
{
    ...
    public static class NotificationSettingNames
    {
        ...
        /// "HelloGoddess.Infrastructure.Notifications.ReceiveNotifications".
        /// </summary>
        public const string ReceiveNotifications = "HelloGoddess.Infrastructure.Notifications.ReceiveNotifications";
    }
}