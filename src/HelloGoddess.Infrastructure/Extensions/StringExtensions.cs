...
namespace HelloGoddess.Infrastructure.Extensions
{
    /// <summary>
    ...
    public static class StringExtensions
    {
        ...
        {
            return EnsureEndsWith(str, c, StringComparison.CurrentCulture);
        }
        ...
        public static string EnsureEndsWith(this string str, char c, bool ignoreCase, CultureInfo culture)
        {
            ...
            if (str.EndsWith(c.ToString(), StringComparison.CurrentCultureIgnoreCase ))
            {
                return str;
            }
        ...
        public static string EnsureStartsWith(this string str, char c, bool ignoreCase, CultureInfo culture)
        {
            ...
            if (str.StartsWith(c.ToString(), StringComparison.CurrentCultureIgnoreCase ))
            {
                return str;
            }
