...
namespace HelloGoddess.Infrastructure.Reflection
{
    ...
    internal static class ReflectionHelper
    {
        ...
        {
            var type = givenType.GetTypeInfo();
        ...
        public static List<object> GetAttributesOfMemberAndDeclaringType(MemberInfo memberInfo)
        {
            ...
            {
                attributeList.AddRange(memberInfo.DeclaringType.GetTypeInfo().GetCustomAttributes(true));
            }
            ...
            where TAttribute : Attribute
        {
            ...
            {
                attributeList.AddRange(memberInfo.DeclaringType.GetTypeInfo().GetCustomAttributes(typeof(TAttribute), true).Cast<TAttribute>());
            }
