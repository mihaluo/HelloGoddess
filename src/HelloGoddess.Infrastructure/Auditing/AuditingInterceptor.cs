...
using HelloGoddess.Infrastructure.Aspects;
...
namespace HelloGoddess.Infrastructure.Auditing
{
    internal class AuditingInterceptor : IInterceptor
    {
        ...
        public void Intercept(IInvocation invocation)
        {
            ...
            var auditInfo = _auditingHelper.CreateAuditInfo(invocation.MethodInvocationTarget, invocation.Arguments) as AuditInfo;
