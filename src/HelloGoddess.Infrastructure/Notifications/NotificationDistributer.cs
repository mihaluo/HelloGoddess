...
using HelloGoddess.Infrastructure.Domain.Services;
...
namespace HelloGoddess.Infrastructure.Notifications
{
    ...
    public class NotificationDistributer : DomainService, INotificationDistributer
    {
        ...
        public async Task DistributeAsync(Guid notificationId)
        {
            ...
            {
                Logger.LogInformation("NotificationDistributionJob can not continue since could not found notification by id: " + notificationId);
                return;
            }
