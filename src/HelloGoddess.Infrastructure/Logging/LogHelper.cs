...
namespace HelloGoddess.Infrastructure.Logging
{
    ...
    public static class LogHelper
    {
        ...
        static LogHelper()
        {
            Logger = null;//todo yw add logger
        }
        ...
        private static void LogValidationErrors(ILogger logger, Exception exception)
        {
            ...
            ;
            logger.LogInformation("There are " + validationException.ValidationErrors.Count + " validation errors:");
            foreach (var validationResult in validationException.ValidationErrors)
            {
                ...
                logger.LogInformation(validationResult.ErrorMessage + memberNames);
            }
        }
    }
}
