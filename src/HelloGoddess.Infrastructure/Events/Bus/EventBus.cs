...
using Abp;
using HelloGoddess.Infrastructure.Events.Bus.Factories;
using HelloGoddess.Infrastructure.Events.Bus.Factories.Internals;
using HelloGoddess.Infrastructure.Events.Bus.Handlers;
using HelloGoddess.Infrastructure.Events.Bus.Handlers.Internals;
using HelloGoddess.Infrastructure.Extensions;
using HelloGoddess.Infrastructure.Threading.Extensions;
    ...
    public class EventBus : IEventBus
    {
        ...
        private void TriggerHandlingException(Type eventType, object eventSource, IEventData eventData, List<Exception> exceptions)
        {
            ...
            foreach (var factoryToTrigger in GetHandlerFactories(eventType))
            {
                ...
                {
                    handlerType
                        .GetMethod("HandleEvent", BindingFlags.Public | BindingFlags.Instance)
                ...
                typeof(IEventDataWithInheritableGenericArgument).IsAssignableFrom(eventType))
            {
                ...
                var baseArg = genericArg.DeclaringType;
                if (baseArg != null)
                {
