...
namespace HelloGoddess.Infrastructure.Localization.Sources.Resource
{
    /// <summary>
    ...
    public class ResourceFileLocalizationSource : ILocalizationSource, ISingletonDependency
    {
        ...
        public virtual string GetString(string name)
        {
            ...
            if (value == null)
            {
                return ReturnGivenNameOrThrowException(name, CultureInfo.CurrentCulture);
            }
        ...
        {
            return GetAllStrings(CultureInfo.CurrentCulture, includeDefaults);
        }
        ...
        public virtual IReadOnlyList<LocalizedString> GetAllStrings(CultureInfo culture, bool includeDefaults = true)
        {
            ...
            //    .GetString(culture, true, includeDefaults)
