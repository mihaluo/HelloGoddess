...
using HelloGoddess.Infrastructure.Xml.Extensions;

namespace HelloGoddess.Infrastructure.Localization.Dictionaries.Xml
{
    /// <summary>
    ...
    public class XmlLocalizationDictionary : LocalizationDictionary
    {
        ...
        public static XmlLocalizationDictionary BuildFomXmlString(string xmlString)
        {
            ...
            var localizationDictionaryNode = xmlDocument.GetElementsByTagName("/localizationDictionary");
            ...
            var textNodes = xmlDocument.GetElementsByTagName("/localizationDictionary/texts/text");
            if (textNodes != null)
            {
