...
namespace HelloGoddess.Infrastructure.Application.Features
{
    ...
    {       
        ...
        {
            return string.Equals(await featureChecker.GetValueAsync(featureName), "true", StringComparison.CurrentCultureIgnoreCase);
        }
        ...
        {
            return string.Equals(await featureChecker.GetValueAsync(tenantId, featureName), "true", StringComparison.CurrentCultureIgnoreCase);
        }
